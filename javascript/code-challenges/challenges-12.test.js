...
const replaceZeros = (string) => {
  let reviewRegex = /[0-0]/g;
  return string.replace(reviewRegex, 'zero');
};
...
const validateEmail = (email) => {
 const regex4 = /^\w+[\w.]\w+@\w*.(com|net|org)$/
 return regex4.test(email);
};
